...
\label{dpü}
\vspace{-2ex}
\textbf{Da sowohl der Einstieg in's Studium als auch diese Fibel selbst mit Informationen sowie Links dazu voll gepackt ist (und es gerade am Anfang nicht immer eindeutig ist, wo genau was steht), findet ihr hier eine Übersicht aller hilfreichen Links.}
...
\begin{description}[parsep=1ex, leftmargin=0pt, itemsep=0.2ex]
	...
	Info-Seite VGM: \url{https://westfalentarif.de} \quad (Unter SemesterTicket $\rightarrow$ Münster)
