\section[Primi-Überlebenszettel (DPÜ, wichtige Links)]{Der Primi-Überlebenszettel~(DPÜ)}
\label{dpü}
\vspace{-2ex}
...
\begin{description}[parsep=1ex, leftmargin=0pt, itemsep=0.2ex]
	...
	\item[Semesterticket/NRW-Ticket:] \url{http://www.asta.ms/angebote/studium/semesterticket}\\
	...
	\item[Kultursemesterticket:] \url{http://www.asta.ms/hochschulpolitik/themen/kultursemesterticket}
