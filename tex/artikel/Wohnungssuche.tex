...
Bevor du zu Versuch 10 greifst, gibt es noch die Möglichkeit bei netten Studenten unterzukommen, die ihr Sofa für Neuankömmlinge anbieten. Man lernt auf diese Weise schnell neue Leute kennen, die nicht unbedingt Physik studieren, aber ein sehr großes Herz und hoffentlich ein noch größeres Sofa haben. Finden könnt ihr diese Angebote unter \url{https://www.asta.ms/de/wohnboerse}.

\subsection{9.~Versuch: Notunterkünfte}
Am Semesteranfang bietet das Studierendenwerk Notunterkünfte an, bei denen du zumindest ein Dach über dem Kopf hast. Außerdem gibt es dieses Jahr in der O-Woche zum zweiten Mal die Möglichkeit, in einer Sporthalle des Hochschulsports zu übernachten. 

\subsection{10.~Versuch: Doch die Parkbank}
