...
Neben dem Studentenwerk Münster gibt es auch noch Häuser verschiedener Verbindungen (mein Rat: Finger weg!) und Wohnheime in kirchlicher oder privater Trägerschaft, wobei die ersteren der beiden teilweise noch streng nach Männlein und Weiblein trennen.
...
Anträge erhältst du beim jeweiligen Träger (eigentlich immer im Haus selbst, außer beim Studentenwerk, hier befindet sich die Verwaltung an der Bismarckallee direkt neben der Mensa am Aasee).
...
\begin{itemize}[leftmargin=0.8cm]
	\raggedright
	\item \url{http://www.asta.ms/angebote/wohnen}
