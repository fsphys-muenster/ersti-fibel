...
Zusätzlich gilt das Ticket auch für ausgewählte Bahn-Strecken außerhalb von NRW, z.\,B.\ von Münster nach Osnabrück, Enschede (Niederlande) und Lingen oder auch von Lengerich (Westfalen) nach Osnabrück (Details siehe Webseiten im "Ersti-Überlebenszettel" bzw.\ am Artikelende).
...
Seit dem Sommersemester 2024 ist das Semesterticket gleichbedeutend mit dem Deutschland-Ticket (nur vergünstigter als (Groß-)Teil des Semesterbeitrages). Damit ist allerdings als unerwünschter Nebeneffekt die Mitnahmeregelung von eben erwähnten Fahrrädern und Kindern (was nicht zwangsläufig jedem Studierenden gefallen muss). 
