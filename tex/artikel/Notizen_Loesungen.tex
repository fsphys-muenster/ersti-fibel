...
\begin{tikzpicture}[remember picture, overlay]
	\node[anchor=west, yshift=-3mm, inner sep=0] at (current page text area.west)
...
\rotatebox{180}{
	\begin{minipage}{0.8\textwidth}
		...
		\ref{itm:rätsel_götter}a (nach den Göttern Thingsus [Kriegsgott], Freya und Donar [Wettergott]),
		\ref{itm:rätsel_xi}a,
