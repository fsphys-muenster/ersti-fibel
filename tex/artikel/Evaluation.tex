...
Um die Auswertung zu beschleunigen und Probleme zu umgehen, die sich bei einer analogen Evaluation nicht vermeiden lassen, wird die Evaluation nach und nach auf eine Online-Evaluation umgestellt. Diese erfolgen jedoch nach wie vor in Präsenz, also während der Vorlesung, um die Anzahl an Teilnehmern gegenüber einer analogen Evaluation konstant zu halten.
