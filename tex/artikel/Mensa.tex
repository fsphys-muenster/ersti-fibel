...
\textbf{(Corona bedingt steht noch nicht fest, ob die Mensa am Ring zum Semesterstart regulär geöffnet wird. Eine Alternative bietet das Viva Café, das direkt an der Mensa liegt. Außerdem soll die Mensa Da Vinci (am Leonardo-Campus) und das Bistro Denkpause (zw. der FH und dem Institut für Geographie) wieder geöffnet werden. Informiert euch am besten auf der Internetseite des Studierenden Werks, welche der genannten Möglichkeiten aktuell geöffnet haben.}
