...
Für die Leute, die nicht jeden Tag nach Hause fahren oder selber kochen können -- also wenn Mutti/Vati zu weit weg wohnt -- gibt es die Mensa.
...
\textbf{Leider gibt es aktuell noch Corona-Beschränkungen. Nach unserem letzen Stand gelten in allen Mensen die 3G-Regelungen und das Bezahlen erfolgt nur bargeldlos mit eurem Studierendenausweis. In der Mensa am Ring ist aktuell nur die obere Etage geöffnet und es gibt maximal Vierertische. Das Viva Café direkt an der Mensa und das Bistro Denkpause zwischen der FH und dem Institut für Geographie haben aktuell leider geschlossen. Die neuesten Informationen findet ihr auf der Webseite des Studierendenwerks.}

Dort erwartet euch dann meist eine große Schlange, denn um 12~Uhr ist der Anlauf dort am größten – die Studierenden der Chemie haben Vorlesungen oft bis Punkt zwölf und kombinieren sich mit Trödlern und Leuten, die einen weiteren Weg haben. Ältere Semester (oder Leute die dies hier gelesen haben) werden sich daher entweder gegen 11:45~Uhr beeilen, oder wenn möglich ein wenig warten. Um etwa 12:20~Uhr ist es meist schon wieder wesentlich leerer.
Doch diese Schlange ist meist nach kurzer Zeit überwunden und da man normalerweise in Gruppen essen geht auch nicht so schlimm. Schwieriger ist da die Platzsuche, insbesondere für größere Gruppen. Gegen 12~Uhr ist die Mensa am vollsten, sodass vier Personen Probleme bekommen können zusammen zu sitzen, danach leert sie sich langsam wieder. Um etwa 12:20~Uhr wird man kaum noch Sitzplatzprobleme haben.
Bevor man sich anstellt, ist es aber hilfreich, ein Bisschen über die Mensa wissen!
...
Abhilfe schafft hier meistens die Bezahlung durch Kommilitonen oder Kommilitoninnen mit Menü.
Die Glasschälchen mit ausgefalleneren Desserts sind für \SI{0,95}{\euro} zu haben.


Nach einigen Mensabesuchen wirst du jedoch schnell bemerken, dass die Menüauswahl sich alle 4--6~Wochen wiederholt.
Das ist aber gar nicht so schlimm, denn die Menüs schmecken dann wieder genauso gut oder schlecht wie zuvor.
