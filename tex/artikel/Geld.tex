...
Auch die Beratung im Servicebüro des Amts für Ausbildungsförderung (über der Mensa~I: Bismarckallee~11, E-Mail: \email{bafoeg@studentenwerk-muenster.de}) und die gebührenfreie Telefonberatung des BMBF (Tel.:~\phonenumber{0800 2236341}, Mo--Fr 8--20~Uhr) sind für den Anfang sehr nützlich.
Genaueres erfahrt ihr im Internet unter \cref{geld:studentenwerk-ms}.
...
Wer sich gerne detaillierter über die Berechnungsgrundlagen informieren will, der findet dazu z.\,B.\ Möglichkeiten im Internet, etwa auf der offiziellen Seite des BMBF, wo es auch alle Formulare zum Download gibt \cref{geld:bmbf}, auf der oben genannten Infoseite des Amtes für Ausbildungsförderung in Münster \cref{geld:studentenwerk-ms} oder auf der Seite der Studentenwerke \cref{geld:studentenwerke}.
...
Genug der Vorrede, nun zur Sache: Die Förderung beträgt deutschlandweit bei den aktuell gültigen Sätzen (seit August~2016) maximal \SI{735}{\euro} (eigenständig wohnende Studenten) bzw.\ \SI{537}{\euro} (bei den Eltern wohnende Studenten).
Diese Förderung setzt sich zusammen aus dem Grundbetrag inkl.\ Wohnzuschlag (\SI{649}{\euro} bzw.\ \SI{451}{\euro}) und dem optionalen KV-/PV-Zuschlag (\SI{71}{\euro} und \SI{15}{\euro}) für Studierende, die selber kranken- bzw.\ pflegeversichert sind.
...
Der Anspruch besteht ab Studienbeginn, d.\,h.\ in eurem Fall zumindest ab dem 1.~Oktober~2016, aber erst ab dem Monat, in dem ihr den Antrag gestellt habt.
...
Habt ihr größere Ersparnisse, so wird der über einen gewissen Freibetrag (für ledige, kinderlose Auszubildende seit 2016: \SI{7500}{\euro}) hinausgehende Anteil ebenfalls zu eurem Einkommen hinzugerechnet (\num{1/12} davon pro Monat).
...
\begin{tikzpicture}[remember picture, overlay]
	\node[inner sep=0, yshift=3.5cm] at (current page.center)
...
0cm \columnwidth
Wie ihr vielleicht schon festgestellt habt, seid ihr die ersten Studenten, die sich an den zum Wintersemester~2016/2017 erhöhten Bedarfssätzen und Freibeträgen des BAföG erfreuen können.
Im Vergleich zu vorher (letzte Änderung 2010!) wurden die Bedarfssätze um \SI{7}{\percent} und der Wohngeldzuschlag um \SI{11}{\percent} angehoben.
Das hört sich zwar zunächst gut an, jedoch betrug schon der Anstieg der Verbraucherpreise bereits vier Jahre nach der letzten Erhöhung, d.\,h.\ zwischen 2010 und 2014, ebenfalls \SI{7}{\percent}.
...
\begin{flushleft}
	...
	\end{fibelurl}
	\begin{fibelurl}
		\url{http://www.asta.ms/angebote/beratung/sozialberatung}
	...
	\end{fibelurl}
	\begin{fibelurl}
		\url{http://www.studis-online.de/StudInfo/Studienfinanzierung/rundfunkbeitrag-fuer-studenten.php}
