...
\begin{wraptable}{r}{0cm}
        ...
        &&\\
        \hline
        \multirow{4}{1cm}{5. (WiSe)} & \multirow{4}{3cm}{\makecell{Struktur der\\ Materie \\ \footnotesize 27~LP}} & \multirow{8}{3cm}{\makecell{Grundlagen der\\Fachdidaktik und \\Erkenntnistheorie\\\footnotesize 8~LP}} \\
        &&\\
        &&\\
        &&\\
        \cline{1-2}
