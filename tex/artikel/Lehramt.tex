...
Des Weiteren wird das Modul Grundlagen der Fachdidaktik und Erkenntnistheorie absolviert. Es beinhaltet eine Vorlesung zur Einführung in die Fachdidaktik der Physik für das Lehramt Physik mit abschließender mündlichen Prüfung sowie ein Seminar zur Theorie, Geschichte und Kultur der Naturwissenschaften, in dem ihr eine Seminararbeit, z. B. ein Referat oder Lernvideo, erstellen müsst, welches nicht benotet wird. Sowohl Vorlesung als auch Seminar werden in der Regel jedes Semester angeboten und können ab dem 3. Semester unabhängig voneinander belegt werden. Manche Termine überschneiden sich allerdings mit Vorlesungen der Physikmodule.\\
...
\begin{wraptable}[29]{r}{2cm}
        ...
        &&\\
        \hline
        \multirow{4}{1cm}{5. (WiSe)} & \multirow{4}{3.2cm}{\makecell{Struktur der\\ Materie \\ \footnotesize 12~LP}} & \multirow{7}{3cm}{\makecell{Grundlagen der\\Fachdidaktik und \\Erkenntnistheorie\\\footnotesize 4~LP}} \\
        &&\\
        &&\\
        &&\\
        \cline{1-2}
        \multirow{5}{1cm}{6. (SoSe)} & \multirow{3}{3.5cm}{\makecell{Messtechnik und\\Signalverarbeitung \\ \footnotesize 8~LP}} & \\
        &&\\
	&&\\
        \cline{3-3}
        & \multirow{2}{3cm}{\makecell{Bachelorarbeit \\ \footnotesize 10~LP~(WPM)}} &\\
        &&\\
        \hline
    \end{tabular}
...
\node[anchor=south east,xshift=-1.88cm,yshift=3.5cm]{
	\fibelimgtext{
		\includegraphics[width=.8\columnwidth]{res/xkcd/xkcd_lehramt.jpg}
