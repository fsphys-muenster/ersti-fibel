...
Da sich die Prüfungsordnung bisher jedes Jahr wieder geändert hat, gehe ich davon aus, dass die Version, über die ich hier schreibe (Bachelor-Prüfungsordnung vom Sommersemester 2020), schon bald nicht mehr aktuell sein könnte.

Des Weiteren sei direkt vorweggenommen, dass der Bachelor in der Physik praktisch \emph{kein} berufsqualifizierender Abschluss ist, sondern die Wirtschaft den Abschluss häufig erst ab einem Master in Physik akzeptiert.
...
In der neuesten Prüfungsordnung gehen die zwei besten Noten der Module Physik~I und II mit je \SI{10}{\percent} gewichtet in die Endnote ein. Hinzu kommt die Note des Moduls Physik~3 mit weiteren \SI{10}{\percent}.
