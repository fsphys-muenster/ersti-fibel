...
\begin{center}
	\vspace{-0.5cm}
	\includegraphics[width=0.7\textwidth]{res/fsphys_logo_ms_weiss.pdf}
	\vspace{-0.5cm}
\end{center}
\begin{multicols}{2}
...
Zur Zeit findet die Sitzung mittwochs um 18~Uhr (s.\,t.~=~Punkt 18:00~Uhr) im Raum IGI 87 statt.
...
\begin{center}
	\vspace{-2mm}
	\includegraphics[width=1.3\columnwidth, height=0.42\textheight]{res/vorstellungsfotos/FS_Physik_2024.JPG}
\end{center}
