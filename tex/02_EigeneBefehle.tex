...
\newcommand{\authorA}{Marius Willer}
\newcommand{\authorB}{Sarah Hesse}
\newcommand{\authorC}{Jeffrey Stolte}
%\newcommand{\authorD}{Alexander Marco Tiekötter}
\newcommand{\fibelautor}{Fachschaft Physik der \UniMuenster{} ; \authorA, \authorB, \authorC}
