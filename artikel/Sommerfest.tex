...
\includegraphicscompressed[width=\columnwidth]{res/sommerfest_grill.png}
...
\fibelsig{Benedikt, Bernd, Andreas G.}

\includegraphicscompressed[width=\columnwidth]{res/sommerfest_zelt.png}
\end{multicols*}
