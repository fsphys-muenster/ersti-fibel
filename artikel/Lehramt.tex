...
\begin{center}
\includegraphics[width=0.6\columnwidth]{res/comics/calvin_schreibtisch.png}
\end{center}
...
\node[inner sep=0, yshift=1cm] at (current page.center)
{\includegraphics[width=8.8cm]{res/daumen_hoch.jpg}};
\end{tikzpicture}%
...
% XXX
%\begin{center}
%\includegraphics[width=0.9\columnwidth]{res/daumen_hoch.jpg}
%\end{center}
...
%4.7cm \dimexpr\columnwidth - 4.7cm
%4.7cm \dimexpr\columnwidth - 4.7cm
%4.3cm \dimexpr\columnwidth - 4.3cm
4cm \dimexpr\columnwidth - 4cm
4cm \dimexpr\columnwidth - 4cm
